...
export function Footer() {
  ...
  return (
    <footer className="bg-brand-primary-dark text-white mt-auto border-t-4 border-brand-gold" role="contentinfo">
      <div className="max-w-6xl mx-auto px-4 py-8 sm:py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-xs text-neutral-200 mt-2 opacity-90">
          ...
          {/* Quick Links */}
          <div className="text-center md:text-left">
            <h3 className="text-base font-semibold mb-4 text-brand-gold-light">Hızlı Erişim</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <a
                  href="/"
                  className="footer-link"
                  aria-label="İftar saatleri sayfasına git"
                >
                  İftar Saatleri
                </a>
              </li>
              <li>
                <a
                  ...
                  className="footer-link"
                  aria-label="Namaz vakitleri sayfasına git"
                >
                  Namaz Vakitleri
                </a>
              </li>
          ...
          {/* About & Credits */}
          <div className="text-center md:text-left">
            <h3 className="text-base font-semibold mb-4 text-brand-gold-light">Hakkında</h3>
            <div className="text-sm text-neutral-200 space-y-2">
              <p>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-medium hover:text-brand-gold-light transition-colors underline decoration-brand-gold/50"
                  aria-label="Tarık Tunç kişisel web sitesi"
                >
                  Tarık Tunç
                </a>
              ...
              <p>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 hover:text-brand-gold-light transition-colors"
                  aria-label="Blakfy web sitesi"
                >
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM4.332 8.027a6.012 6.012 0 011.912-2.706C6.512 5.73 6.974 6 7.5 6A1.5 1.5 0 019 7.5V8a2 2 0 004 0c0-1.1.9-2 2-2 .463 0 .902.13 1.27.362A5.99 5.99 0 0118 10c0 .98-.234 1.903-.65 2.72-.583-.162-1.2-.25-1.85-.25-2.8 0-5.2 1.68-6.24 4.09A6.013 6.013 0 014.332 8.027z" clipRule="evenodd"/>
                  </svg>
                  blakfy.com
                </a>
              </p>
              <p>
                <a
                  href="https://github.com/tariktunc/namaz-vakitleri-last-version"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 hover:text-brand-gold-light transition-colors"
                  aria-label="GitHub proje deposu"
                >
        ...
        <div className="border-t border-white/15 pt-6">
          {/* Bottom Bar */}
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-neutral-200">
            ...
            <div className="order-1 sm:order-2 flex items-center gap-4">
              <p className="flex items-center gap-1">
                <svg className="w-4 h-4 text-brand-gold-light" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-neutral-200 opacity-75 leading-relaxed">
